"""
This code creates folder and images with cropped faces using yoloV5 detector, basically, the test_pair of custom dataset
is used to read the files required and then each of those images are passed through detector and lastly the image are saved in
...
lfw_dir = "/home/ahmadob/dataset/facerecognition_dataset/test_set"
lfw_face_dir = "/home/ahmadob/dataset/facerecognition_dataset/test_face_set"
...
for i in pair_lines:
    pths = i.split(' ')
    lfw_path.append(pths[0])
    lfw_path.append(pths[1])
